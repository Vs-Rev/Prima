...
| B. Physics              | Das Kart erfährt Einwirkung von Kräften bei Beschleunigung, Drehung, Bremsung, Fall und Collision. (forces + collisions + torques) Alle Objekte, bis auf Dekorationen wie das Hintergrundbild oder die Warnsymbole, besitzen Ridgid Bodys. Das Spiel implementiert ein durchaus realistischen Physik-Basierten Auto-ähnlichen Kart-Controller. Die Bewegungen werden auf physikalischen Grundlagen berechnet und ausgeführt. |      
| (E. Animation)              | Animationen in Form von Sprite-Sheet Berechnungen sind implementiert, jedoch aufgrund eines Code-Basierten Implementierungsfehler des Karts nicht einbezogen.  |                                                                                                                                                                                                                                                                     |
|                         |                                                                                                                                                                                                                                                                                                                                                                                          |
